...
const PageTemplate = ({children}) =>
    <div className="page" style={{border: "4px dashed purple"}}>
        <MainMenu />
        {children}
    </div>
...
export const Whoops404 = ({ location }) =>
    <div className="whoops-404">
        <h1>Resource not found at '{location.pathname}'<br />
        <span style={{fontFamily: 'courier', color: 'green'}}>Let off some steam, Bennett!</span></h1>
    </div>
...
export const About = ({ match }) =>
    <PageTemplate>
        <section className="about">
            ...
            <Route path="/about/motto" component={Motto}/>
...
export const Motto = () => (
    <section className="motto">
        <h2 style={{fontSize: '150%'}}>Our Motto:</h2>
        <h2 style={{fontSize: '150%', color: 'purple'}}>"Nolite te bastardes carborundorum"</h2>
        <p>
